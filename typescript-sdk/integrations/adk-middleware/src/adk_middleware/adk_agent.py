    ...
    async def _run_adk_in_background(
        ...
        try:
            ...
            async for adk_event in runner.run_async(
                ...
                non_llm_direct_response_event = has_content and not adk_event.usage_metadata
                ...
                if (not final_response
                        or state_delta_event
                        or non_llm_direct_response_event
                        or final_text_response_event
                ):
